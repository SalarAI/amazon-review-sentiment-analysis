...
const data: PresentationData = {
  ...
  tables: [
    ...
    { title:{fa:"برندهای برتر بر اساس امتیاز",en:"Top brands by average rating"}, description:{fa:"برندهای پرتکرار با بهترین میانگین امتیاز.",en:"Frequently reviewed brands with the highest average ratings."}, columns:[{fa:"برند",en:"Brand"},{fa:"میانگین",en:"Average"},{fa:"تعداد نقد",en:"Reviews"}], rows:[["Anker","4.244","9,860"],["AmazonBasics","4.201","13,213"],["Sabrent","4.028","7,320"],["SanDisk","3.959","8,400"],["Logitech","3.954","17,066"]], source:"top_10_brands_by_review_count.ipynb · cell 9" },
    { title:{fa:"کاربران پرتکرار",en:"Most active reviewers"}, description:{fa:"نام‌هایی با بیشترین فعالیت ثبت‌شده در خروجی notebook.",en:"Reviewer names with the largest recorded activity."}, columns:[{fa:"نام",en:"Reviewer"},{fa:"تعداد",en:"Count"}], rows:[["Benson Leung","4,572"],["Michael","3,710"],["Mike","3,000"],["John","2,730"],["Dave","2,230"]], source:"Top_10_names_3.ipynb · cell 8" }
  ],
  groups: [
    { title: { fa: "توزیع امتیاز و طول نقد", en: "Rating and review-length distributions" }, description: { fa: "خروجی‌های مستقیم notebookهای تحلیل توزیع.", en: "Direct outputs from the distribution-analysis notebooks." }, visuals: [
